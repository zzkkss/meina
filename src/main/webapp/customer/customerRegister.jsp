    	...
    	//$("#msg").css("display","");
    	 document.getElementById('msg').style.display="";  
								...
								<div class="col-xs-12">
									...
									<div class="form-group">
										<label>名称</label> <input type="text" class="form-control" id="title"  name="title"  placeholder="请输入名称">
									...
									<button type="button" class="btn btn-default" id="registerShop">提交修改</button>
