    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" id="top" role="navigation" style="margin-bottom: 0">
          ...
          <div class="navbar-header">
                <a class="navbar-brand" id="navbar-brand" href="index.html">管理系统:</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <li class="">
                ...
                <li class="">
                    <a href="/shop.do?logout=1" target="_parent">
            ...
            <div class="navbar-default sidebar" id="right" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a id="shopinfo" href="/shop/shopInfo.html"><i class="fa fa-dashboard fa-fw"></i> 商户信息</a>
                        </li>
                        <li>
                            <a id="productAdmin" href="/shop/productAdmin.html"><i class="fa fa-table fa-fw"></i> 产品管理</a>
                        </li>
                       <!--  <li>
                            <a id="customerAdmin" href="/shop/customerAdmin.html"><i class="fa fa-edit fa-fw"></i> 客户管理</a>
                        </li> -->
                        <li>
                            <a id="couponAdmin" href="/shop/couponAdmin.html"><i class="fa fa-edit fa-fw"></i> 优惠券管理</a>
                        </li>
...
$("#xiugaimimabtn").click(function () {
	if($("#pas1").val()==$("#pas2").val()){
	    ...
	    var actionUrl = "/shop/changePassword.do";  
	    $.ajax({  
	    	 type:"get",
	        url : actionUrl,  
	        data : params,  
