...
@Repository("weixinArticleDao")
public class WinxinArticleDaoImpl extends BaseDaoImpl<WeixinArticle> implements WeixinArticleDao {


	public Map<String, Object> getByPage(Jqpage jqpage, String... strings) {
		// TODO Auto-generated method stub
		Criteria criteria=this.getSession().createCriteria(WeixinArticle.class);
		...
		jqpage.setTotalRecords(criteria.list().size());
			...
			List<WeixinArticle> list= criteria.list();
	...
	public List<WeixinArticle> lastArticle(int num) {
		...
		List<WeixinArticle> a=criteria.list();
	return a;
	}
